...
import com.hz.gather.master.core.mapper.TaskHodgepodgeMapper;
import com.hz.gather.master.core.model.entity.UCashOutLog;
import com.hz.gather.master.core.service.TaskHodgepodgeService;
...
public class TaskHodgepodgeServiceImpl<T> extends BaseServiceImpl<T> implements TaskHodgepodgeService<T> {
    ...
    @Override
    public List<UCashOutLog> getTransferResultList(Object obj) {
        return taskHodgepodgeMapper.getTransferResultList(obj);
    }
